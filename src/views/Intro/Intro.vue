    ...
    <div class="page-container" style="width:99%;margin-top:15px;">
        <el-carousel :interval="3000" type="card" height="450px" class="carousel">
            <el-carousel-item class="carousel-item-intro">
                <h2>项目介绍</h2>
                <ul>
                    <li>基于 Spring Boot、Spring Cloud、Vue、Element的平台</li>
                </ul>
            ...
            <el-carousel-item class="carousel-item-func">
                ...
                <ul>
                    ...
                    <li>✔ apk管理：新建应用，修改应用，删除应用，查询应用</li>
                    <li>✔ 脚本管理：新建脚本，修改脚本，删除脚本，查询脚本</li>
                    <li>✔ 平台管理：新建平台，修改平台，删除平台，查询平台</li>
            ...
            <el-carousel-item class="carousel-item-env">
                <h2>开发环境</h2>
                <ul>
                    <li>IDE后端 : STS :4.5.1 。JDK : JDK 1.8.x</li>
                    <li>构建环境 : Maven : Maven 3.5.4。 MySQL: MySQL 5.7.x。</li>
                    <li>IDE : VS Code 1.42。 Webpack：webpack 3.2.x。</li>
